...
def build_parser() -> argparse.ArgumentParser:
    ...
    p.add_argument(
        "--mh",
        type=float,
        default=active_mass_gev(),
        help=(
            "[m2] h1 mass in GeV. The Python orchestrator resolves an omitted "
            "value from the active v3 convention; the direct C++ evaluator "
            "always requires named --mh."
        ),
    )
