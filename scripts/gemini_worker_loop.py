...
def build_prompt(config: dict[str, Any], worker_state: dict[str, Any]) -> str:
    ...
    schema = {
        ...
        "template_name": "ctau_mphi_mA_refine|mphi_lower_edge_probe|mA_upper_edge_probe|sensitivity_probe|control_box",
        "template_overrides": {
            ...
            "variable": "tan_beta|lambda6|mA|lambda1",
...
def build_repair_prompt(config: dict[str, Any], worker_state: dict[str, Any], plancheck: dict[str, Any]) -> str:
    return (
        ...
        "Templates: ctau_mphi_mA_refine, mphi_lower_edge_probe, mA_upper_edge_probe, sensitivity_probe, control_box.\n"
    )
