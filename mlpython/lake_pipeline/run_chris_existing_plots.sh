#!/usr/bin/env bash
# Reproducibly plot Christopher's production run using existing mlpython/lake_pipeline tools.
#
# Usage:
#   bash mlpython/lake_pipeline/run_chris_existing_plots.sh [INPUT_CSV [OUTPUT_ROOT]]
#
# Defaults:
